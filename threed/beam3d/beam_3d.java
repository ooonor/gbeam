 ...
 */
public class beam_3d extends Application {
    ...
    private void buildAxes() {
        ...
        // first, read in the file of points for rectangles
        ...
        try{
            ...
            title = in.nextLine();
            nRect = in.nextInt();
            if(nRect < 0) {  // flag to add array elements, too, and read in array type
                nRect = -nRect;
